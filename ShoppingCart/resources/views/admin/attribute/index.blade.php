                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($attribute as $index => $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>
                                            <a href="{{ url('/admin/attribute/' . $item->id) }}" title="View Attribute"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                            <a href="{{ url('/admin/attribute/' . $item->id . '/edit') }}" title="Edit Attribute"><button class="btn btn-primary btn-sm"><i class="fas fa-edit" aria-hidden="true"></i></button></a>
