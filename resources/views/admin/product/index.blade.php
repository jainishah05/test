                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Name</th><th>Category</th><th>Product Code</th><th>Featured</th><th>Recommended</th><th>Description</th><th>Price</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($product as $index => $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->price }}</td>
                                        <td>
                                            {{-- <a href="{{ url('/admin/product/' . $item->id) }}" title="View ProductImage"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a> --}}
