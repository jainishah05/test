            ...
            <div class="col-md-9 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('admin/attribute-value/'. $attributevalue->id) }}" accept-charset="UTF-8" class="form-horizontal" >
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
                            ...
                            <div class="form-group {{ $errors->has('value') ? 'has-error' : ''}}">
                                ...
                                <input class="form-control" name="value" type="text" id="value" value=" {{ $attributevalue->value }}" >
